      ...
      <div className="bg-[#161B22] border border-white/10 rounded-xl w-full max-w-[500px] p-6">
        ...
        <div className="flex justify-end gap-2">
          ...
          <button
            onClick={onConfirm}
            disabled={isPending}
            className="px-4 py-2 rounded-lg flex justify-center items-center cursor-pointer bg-red-500 text-white text-[13px] hover:bg-red-600/90 transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
          >
